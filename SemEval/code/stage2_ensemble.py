...
class GatedIntermediate(nn.Module):
    def __init__(self, num_intermediate_outputs):
        ...
        # self.gating_weights = nn.Parameter(torch.randn(num_intermediate_outputs))
        # self.gating_weights = nn.Parameter(torch.ones(num_intermediate_outputs) / num_intermediate_outputs)
...
class StanceModel_Stage2(nn.Module):
    def __init__(self, bertweet_model,rank,num_heads,hidden_size,num_intermediate_outputs,dropout,num_classes):
        ...
        # Ensemble output
        self.ensemble_output=Ensemble(num_intermediate_outputs)
        # Final Linear layer
    ...
    def forward(self,text_ids,text_mask,aux_feature,loaded_rational_preds,llm1_rational_binary,llm2_rational_binary,llm1_stance,llm2_stance):
        ...
        output=self.ensemble_output([predictions,llm1_stance,llm2_stance])
...
with open("predictions/Stance_ensemble.csv", "w", newline="", encoding="utf-8") as csvfile:
